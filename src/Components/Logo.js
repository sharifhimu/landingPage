...
class Logo extends Component{
	...
	render(){
     	...
     	{/*			<Projects referance={Logoproject[0].referance} cardimg={Logoproject[0].cardimg} name={Logoproject[0].name} button={Logoproject[0].button} />  
            ...
            {Logoproject.map((project,i)=> <Projects referance={Logoproject[i].referance} cardimg={Logoproject[i].cardimg} name={Logoproject[i].name} button={Logoproject[i].button} />   
             )}                 
